...
//    })
//    InboundDetail queryInboundItemListByInboundNoAndItemId(String inboundNo, int itemId);
...
//    int countInboundDetailList(String inboundNo, int offset, int pageSize);
    ...
    @Delete("DELETE FROM inbound_detail_list " +
            "WHERE inbound_no = #{inboundNo} " +
            "AND item_id = #{itemId} ")
    void deleteInboundDetailListByInboundNoAndItemId(@Param("inboundNo") String inboundNo,
